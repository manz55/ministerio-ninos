...
import type { Maestro } from '../types/domain'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3">
          {filtered.map((m) => (
            <button
              ...
              className="text-left bg-white rounded-2xl border-2 border-gray-200 hover:border-indigo-300 p-4 flex items-center gap-3 transition-colors"
            >
